...
%		write(Board),nl,
	...
	alphaBetaAux([Board|Tail],Alpha,Beta,TmpBoard_1,maxX,NewAlpha,NewBoard):-
		Beta > Alpha,
		alphaBeta(Board,Alpha,Beta,minO,Heuristic,TmpBoard_2),
		maxWithBoard(Alpha,TmpBoard_1,Heuristic,TmpBoard_2,NewAlphaAux,NewTmpBoard),
	...
	alphaBetaAux([Board|Tail],Alpha,Beta,TmpBoard_1,minO,NewBeta,NewBoard):-
		Beta > Alpha,
		alphaBeta(Board,Alpha,Beta,maxX,Heuristic,TmpBoard_2),
		minWithBoard(Beta,TmpBoard_1,Heuristic,TmpBoard_2,NewBetaAux,NewTmpBoard),
