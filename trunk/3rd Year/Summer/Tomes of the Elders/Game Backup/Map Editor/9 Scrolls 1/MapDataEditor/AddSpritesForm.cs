...
namespace DataEditor
{
    ...
    public partial class AddSpritesForm : Form
    {
        ...
        public AddSpritesForm(DataEditorForm myParent, AdditionType myType, Data.ParentDataObject NewItem, Size SpriteSheetSize)
        {
            InitializeComponent();
            this.myParent = myParent;
            this.myType = myType;
            this.NewItem = NewItem;
            spriteSheetMaker = new SpriteSheet(ref pictureBox, SpriteSheetSize.Height, SpriteSheetSize.Width);
        }
        #endregion
        ...
        private void AddItembutton_Click(object sender, EventArgs e)
        {
            ...
            {
                myParent.CurrentProject.AddObject(NewItem, spriteSheetMaker);
                myParent.Enabled = true;
                this.Dispose();
            }
            else
        ...
        private void AddSpritesbutton_Click(object sender, EventArgs e)
        {
            ...
            if (dialog.ShowDialog() == DialogResult.OK)
            {
                foreach (string filepath in dialog.FileNames)
                {
                    ...
                    if (newSprite.Width != SpriteSheet.SpriteSize.Width || newSprite.Height != SpriteSheet.SpriteSize.Height)
                    {
