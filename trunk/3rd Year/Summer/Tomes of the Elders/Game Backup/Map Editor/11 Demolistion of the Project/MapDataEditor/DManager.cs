    ...
    {   
        ...
        private void AddTexturesToTheSheet(int ID, int Length, SpriteSheet SSM)
        {
            ...
            if (Length <= SheetEmptySpace)
            {
                ...
                {
                    SpriteSheet.GetSpriteDimensions(ObjectSpriteNumber + i, SheetSize.Width, ref Y, ref X);
            ...
            else
            {
                ...
                {
                    SpriteSheet.GetSpriteDimensions(i, SheetSize.Width, ref Y, ref X);
        ...
        public ArrayList LoadSheets(String FilePath)
        {
            ...
            for (int i = 1; i <= CurrentSheetNumber; i++)
            {
                ...
                SS = new SpriteSheet(DummyPictureBoxRef, SheetSize.Height, SheetSize.Width);
        ...
        public SpriteSheet CreateSpriteSheetMakerForObject(ParentDataObject Object)
        {
            ...
            SSM = new SpriteSheet(DummyPictureBoxRef, SpriteHeight, SpriteWidth);
        ...
        {
            ProjectSheets.Add(new SpriteSheet(DummyPictureBoxRef, SheetSize.Height, SheetSize.Width));
            CurrentSheetNumber++;
        }
