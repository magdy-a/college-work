namespace SecurityPackage
{
    ...
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Load(object sender, System.EventArgs e)
        {
            ...
            //    for (int j = 0; j < 16; j++)
            //    {
            //        //y += MD5.Get_XArr_Index(j, j).ToString() + '\t'; // Test X[k] index
            //        //y += ((j * 16) + j).ToString() + '\t'; // Test T[j] index
            //        //y += myMD5.S[j, j % 4].ToString() + '\t'; // Test #shifts
            //    }
            //}
            ...
            //for (int j = 0; j < 8; j++)
            //{
            //    myList.Add(Convertors.FromBinaryToByte(binarystring.Substring(j * 8, 8)));
            //}
        ...
        private void BtnEncrypt_Click(object sender, System.EventArgs e)
        {
            ...
            //{
            //    output += Convertors.FromIntToBinary(arr[j], 8);
            //}

            //List<char> myList = new List<char>();
            //for (int j = 1; j <= 128; j++)
            //{
            //    myList.Add(output[j - 1]);
            //    if (j % 4 == 0)
            //    {
            //        if (j % 32 == 0)
            //        {
