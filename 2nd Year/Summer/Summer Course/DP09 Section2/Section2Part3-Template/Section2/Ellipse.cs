...
namespace Section2
{
    class Ellipse : Shape
    {
        ...
        public override void Draw(Graphics g)
        {
            ...
            g.DrawRectangle(new Pen(Color.Red), X, Y, R1, R2);
        }
        ...
        public override bool PointInShape(int x, int y)
        {
            ...
            if (radius2 * radius2 * System.Math.Pow(x - centerX, 2) + radius1 * radius1 * System.Math.Pow(y - centerY, 2) <= radius1 * radius1 * radius2 * radius2)
                return true;
            else
                return false;
        }
