...
%					maxX
	...
	alphaBetaAux(_,Alpha,Beta,NewBoard,maxX,Alpha,NewBoard):-	Beta <= Alpha,/*write(Alpha,"  ",Beta,"   Prunned Max"),nl, write("PrunnedList"),nl,printBoardList(List),write("EndPrunnedList"),nl,*/	!.
...
%					minO
	...
	alphaBetaAux(_,Alpha,Beta,NewBoard,minO,Beta,NewBoard):-	Beta <= Alpha,/*write(Alpha,"  ",Beta,"   min"),nl,write("PrunnedList"),nl,printBoardList(List),write("EndPrunnedList"),nl,*/	!.
