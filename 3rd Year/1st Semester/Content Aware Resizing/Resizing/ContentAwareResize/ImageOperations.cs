...
{
	//MyColor Struct Contains R & G & B
	public struct MyColor
    {
        public byte R, G, B;
    }

	//Image Operation Template
	public static class ImageOperations
    {
		//Take Picture Path in String, return the Image in 2D Array of MyColor
		public static MyColor[,] OpenImage(string ImagePath)//O(Width * Height)
        {
		...
		//Calculate the Energy Matrix of the Picture
		public static int[,] CalculateEnergy(MyColor[,] ImageMatrix)//O(Width * Height)
        {
		...
		//Display the Image on a Picture Box
		public static void DisplayImage(MyColor[,] ImageMatrix, PictureBox PicBox)//O(Width * Height)
        {
            // Create Image:
            //==============
			if (ImageMatrix == null)
		...
		//Display the Energy on a Picture Box
		public static void DisplayEnergy(int[,] EnergyMatrix, PictureBox PicBox)//O(Width * Height)
        {
            // Create Image:
            //==============
		...
		//Claculate the Normal Resized Image
		public static MyColor[,] NormalResize(MyColor[,] ImageMatrix, int NewWidth, int NewHeight)//O(Width * Height)
        {
            int i = 0, j = 0;
            int Height = ImageMatrix.GetLength(0);
            int Width = ImageMatrix.GetLength(1);
