...
namespace DataEditor
{
    ...
    public class SpriteSheet
    {
        ...
        /// </summary>
        private Color backgroundColor = Color.FromArgb(255, 0, 255);
        /// <summary>
        /// Pointer to the next empty position.
        /// </summary>
        private Point NextInsertionPosition;
        /// <summary>
        ...
        /// <summary>
        /// PictureBox Ref to Draw In.
        /// </summary>
        internal PictureBox PictureRef
        {
            get { return pictureRef; }
        }
        /// <summary>
        /// Sprite size represented in pixels.
        /// </summary>
        public static Size SpriteSize
        {
        ...
        public SpriteSheet(PictureBox Ref, int Height, int Width)
        {
        ...
        public Bitmap[] SheetBitmaps()
        {
            ...
            {
                GetSpriteDimensions(i, sheetSize.Width, ref Y, ref X);
        ...
        static public void GetSpriteDimensions(int Number, int Width, ref int RowNumber, ref int ColumnNumber)
        {
            if (Number == 0)
            {
        ...
        static public int GetSpriteNumber(int Width, int RowNumber, int ColumnNumber)
        {
